...
- Horizontal Pod Autoscaling (lo vemos en la [práctica de autoescalado](https://github.com/AgustinICAI/asr-cloud-26/tree/main/08-k8s-autoscaling-Entrega/08-k8s-scaling))
