...
- Un sistema de orquestación de contenedores productivo en Google, basado en Borg y Omega,  que han demostrado funcionar en Google durante más de 10 años.
...
![](images/k8s/pod-resources-yaml.png)  
...
![](images/k8s/pod-health-yaml.png)  
...
![](images/k8s/cluster-ip-yaml.png)  
...
![](images/k8s/replicaset-yaml.png)  
